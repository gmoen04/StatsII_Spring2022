...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		%\item
		%How many iterations did it take to find the maximum likelihood estimates?	\vspace{.5cm}
		\vspace{.5cm}
		\lstinputlisting[language=R, firstline=43,lastline=75]{PS2.R} 
		\vspace{.5cm}
	\end{enumerate}
	...
	\begin{enumerate}
		...
		\end{itemize}
	\vspace{.5cm}
	\lstinputlisting[language=R, firstline=76,lastline=193]{PS2.R} 
	\vspace{.5cm}
